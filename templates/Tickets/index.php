    ...
    <div class="row ms-2">
         <div class="col-md-12">
             <ul class="nav nav-pills flex-column flex-md-row mb-3">
                 ...
                 <li class="nav-item">
                     <a class="nav-link" href="<?= DROPSHIPPING ?>/archive-tickets"><i class="bx bx-detail me-1"></i>
                         Archived Tickets</a>
                 </li>
             </ul>
         </div>
                            ...
                            <div class="ms-2 me-2 p-2">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-2 col-sm-12">
                                        ...
                                        <div class="col-lg-2 col-sm-12"> -->
                                            <!-- <div class="mt-4 text-end"> -->
                                                <a href="<?= DROPSHIPPING ?>/tickets" class="btn btn-info">
                                                    Clear
                                                </a>
                                            </div>
                                    </div>
    ...
    $('#addFile').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                // var inputFile = `<input type="hidden" name="atcInput[]" value="<a class="text-decoration-none" href="<?= DROPSHIPPING;?>/img/tickets_file/`+commentData.file+`" target="_blank">`+commentData.file+`</a>"/>`;
