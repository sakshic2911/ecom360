<div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel1">Edit User Permission</h5>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
             </div>
             <div class="modal-body">
                 <?= $this->Form->create(null, ['method' => 'post', 'action' => 'edit_permission','id'=>'roleForm']) ?>
                 <div>
                     ...
                     <div class="text-end">
                         ...
                         <button type="submit" class="btn btn-primary me-2 edtsbmt">Edit</button>
                     </div>
                     <?= $this->Form->end() ?>
                 </div>
             </div>
